...
var commonjs_walker = require('commonjs-walker');

function resolvePackageDependencies(packageJSONs, options, done) {
  var pkgDeps = {};

  var walker = commonjs_walker().register(options.compilers)
